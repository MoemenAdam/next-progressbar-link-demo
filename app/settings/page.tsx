    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-1/3 -right-64 w-[600px] h-[600px] bg-purple-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
        </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-6">
              <div className="flex items-center justify-between">
                <Link href="/" className="flex items-center gap-3 group">
                  <svg className="w-6 h-6 text-purple-400 transform group-hover:-translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                  </svg>
                  <div>
                    <h1 className="text-xl font-bold text-white">Control Panel</h1>
                    <p className="text-xs text-slate-400">Customize your progress bar</p>
                  </div>
                </Link>
              </div>
            </div>
          ...
          <main className="max-w-6xl mx-auto px-6 py-12">
            ...
            <div className="mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/20 border border-indigo-500/30 rounded-full mb-6">
                ...
                <span className="text-sm text-indigo-300 font-medium">Click any link below to see changes</span>
              </div>
              ...
              <p className="text-lg text-slate-300 max-w-2xl">
                Adjust the settings below and click on any navigation link to see your progress bar in action.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {/* Direction Control */}
              <div className="rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 p-8 backdrop-blur-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Choose position and animation</p>
                  </div>
                </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-xs opacity-75 mt-0.5">{dir.position} position</div>
                        </div>
                        {direction === dir.value && (
              ...
              <div className="rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 p-8 backdrop-blur-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Pick your favorite color</p>
                  </div>
                </div>
                    ...
                    {presetColors.map((preset) => (
                      <button
                        ...
                        className={`relative group h-16 rounded-lg transition-all duration-300 hover:scale-110 ${
                          color === preset.value ? 'ring-2 ring-white ring-offset-2 ring-offset-slate-900 scale-105' : ''
                        }`}
            ...
            {/* Code Preview */}
            <div className="mt-12 rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 p-8 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Copy this code to use in your app</p>
                </div>
              </div>
...
/>`}
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText(`<NavigationProgress\n  direction="${direction}"\n  color="${color}"\n/>`);
                  }}
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-12">
              <div className="rounded-xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 p-6">
                ...
                <p className="text-sm text-slate-300">
                  Try different combinations of directions and colors to find the perfect match for your website's design.
                </p>
              </div>
              <div className="rounded-xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 p-6">
                ...
                <p className="text-sm text-slate-300">
                  The progress bar is optimized and lightweight. It won't affect your app's performance.
                </p>
              </div>
            </div>
          </main>
