...
export default async function CustomizationPage() {
  ...
  return (
    <>
      <div className="min-h-screen bg-linear-to-br from-slate-950 via-orange-950 to-slate-900">
                  ...
                  {[
                    {
                      ...
                      desc: 'Top bar, left to right',
                    },
                    {
                      direction: 'top-to-left',
                      desc: 'Top bar, right to left',
                    },
                    {
                      direction: 'bottom-to-right',
                      desc: 'Bottom bar, left to right',
                    },
                    {
                      direction: 'bottom-to-left',
                      desc: 'Bottom bar, right to left',
                    },
                    {
                      direction: 'left-to-bottom',
                      desc: 'Left bar, top to bottom',
                    },
                    {
                      direction: 'left-to-top',
                      desc: 'Left bar, bottom to top',
                    },
                    {
                      direction: 'right-to-bottom',
                      desc: 'Right bar, top to bottom',
                    },
                    {
                      direction: 'right-to-top',
                      desc: 'Right bar, bottom to top',
                    },
                  ].map((item) => (
                    <div
                      key={item.direction}
                    ...
                    >
                      <div className="font-mono text-sm text-orange-400 mb-1">
                        {item.direction}
                      </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mb-3">
                      Control the size and positioning of the progress bar
                      container
                    </p>
                  ...
                  <div>
                    ...
                    <div className="bg-slate-950 rounded-lg p-4 overflow-x-auto">
                      <code className="text-sm text-slate-300 font-mono">
                        progressClassName=&quot;bg-linear-to-r from-purple-500
                        to-pink-500&quot;
                      </code>
                    </div>
                  </div>
...
/>`}
              ...
              {/* Interactive Demo */}
              <div className="rounded-2xl bg-linear-to-br from-orange-600/20 to-amber-600/20 border border-orange-500/30 p-8 text-center">
                <h2 className="text-2xl font-bold text-white mb-4">
                  🎮 Try It Live
                </h2>
                <p className="text-slate-300 mb-6">
                  Head to the control panel to test all customization options in
                  real-time
                </p>
                <Link
                  href="/settings"
                  className="inline-flex items-center gap-2 px-8 py-4 bg-linear-to-r from-orange-600 to-amber-600 text-white font-medium rounded-xl hover:scale-105 transition-all duration-300 shadow-lg shadow-orange-500/30"
                >
