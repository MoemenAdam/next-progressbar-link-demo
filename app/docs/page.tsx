        ...
        <div className="relative z-10">
          ...
          <main className="max-w-5xl mx-auto px-6 py-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-300">Complete guide to using next-progressbar-link</p>
              <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/20 border border-emerald-500/30 rounded-full">
                <span className="text-sm text-emerald-300">Loaded in {data.loadTime}ms</span>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">1. Add to your root layout</h3>
                    <div className="bg-slate-950 rounded-lg p-4 overflow-x-auto">
    ...
    <html>
      <body>
        ...
        {children}
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">2. Use the Link component</h3>
                    <div className="bg-slate-950 rounded-lg p-4 overflow-x-auto">
                      <pre className="text-sm text-slate-300 font-mono">
{`import Link from 'next-progressbar-link';
  ...
  return <Link href="/about">About</Link>;
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-b border-white/10">
                        <th className="py-3 px-4 text-emerald-400 font-semibold">Prop</th>
                        <th className="py-3 px-4 text-emerald-400 font-semibold">Type</th>
                        <th className="py-3 px-4 text-emerald-400 font-semibold">Default</th>
                      </tr>
                    </thead>
                    <tbody className="text-slate-300">
                      <tr className="border-b border-white/5">
                        ...
                        <td className="py-3 px-4 font-mono text-sm">"top-to-right"</td>
                      </tr>
                      <tr className="border-b border-white/5">
                        <td className="py-3 px-4 font-mono text-sm">color</td>
                        <td className="py-3 px-4 text-sm">string</td>
                        <td className="py-3 px-4 font-mono text-sm">"#00b207"</td>
                      </tr>
                      <tr className="border-b border-white/5">
                        <td className="py-3 px-4 font-mono text-sm">containerClassName</td>
                        <td className="py-3 px-4 text-sm">string</td>
                        <td className="py-3 px-4 font-mono text-sm">""</td>
                      </tr>
                      <tr>
                        <td className="py-3 px-4 font-mono text-sm">progressClassName</td>
                        <td className="py-3 px-4 text-sm">string</td>
                        <td className="py-3 px-4 font-mono text-sm">""</td>
                      </tr>
                    </tbody>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Custom Color</h3>
                    <div className="bg-slate-950 rounded-lg p-4 overflow-x-auto">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Bottom Position</h3>
                    <div className="bg-slate-950 rounded-lg p-4 overflow-x-auto">
                      <code className="text-sm text-slate-300 font-mono">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Vertical Bar</h3>
                    <div className="bg-slate-950 rounded-lg p-4 overflow-x-auto">
                      <code className="text-sm text-slate-300 font-mono">
              ...
              {/* Try it */}
              <div className="rounded-2xl bg-gradient-to-br from-emerald-600/20 to-teal-600/20 border border-emerald-500/30 p-8 text-center">
                ...
                <Link
                  href="/settings"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-medium rounded-xl hover:scale-105 transition-all duration-300"
                >
