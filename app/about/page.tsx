        ...
        <div className="relative z-10">
          ...
          <main className="max-w-5xl mx-auto px-6 py-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-300">Learn more about next-progressbar-link</p>
              <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 border border-blue-500/30 rounded-full">
                <span className="text-sm text-blue-300">Loaded in {data.loadTime}ms</span>
              </div>
            </div>

            <div className="prose prose-invert prose-lg max-w-none">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 mb-8">
                <h2 className="text-2xl font-bold text-white mb-4">What is next-progressbar-link?</h2>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 mb-8">
                <h2 className="text-2xl font-bold text-white mb-4">Why was it created?</h2>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                ...
                <ul className="space-y-3 text-slate-300">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-2xl">⚡</span>
                    <span>Zero configuration required - works out of the box</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-2xl">🔄</span>
                    <span>Perfect wrapper around next/link - all props work as expected</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-12">
              ...
              >
                ...
                <p className="text-sm text-slate-400">Explore all capabilities</p>
              </Link>
              <Link
                href="/installation"
                className="group p-6 rounded-xl bg-white/5 border border-white/10 hover:border-white/30 hover:bg-white/10 transition-all duration-300"
